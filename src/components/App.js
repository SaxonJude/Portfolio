                ...
                <div className={landingStyles.content_container}>
                    ...
                    <div className={landingStyles.content_box}>
                        <div ref={el => about = el} className={landingStyles.content_about}>
                            ...
                            <p>
                            Hello, I’m <span>Saxon Du Plooy</span>, born in <span>Durban, SA</span> and re-located to the New Forest when I was 3.  I’m a self-taught front end web developer with a strong <span>passion</span> for web development and constantly learning new skills to grow my knowledge. 
                            </p>
                            <p>
